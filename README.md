...
```
   ...
   repositories {
        ...
        maven {
            credentials {
                username '605c5a273fd856bdf3101c9a'
                password 'DHcYsFK[4zv-'
            }
            url 'https://packages.aliyun.com/maven/repository/2253054-release-dyTPUK/'
        }
        maven {
            credentials {
                username '605c5a273fd856bdf3101c9a'
            ...
            url 'https://packages.aliyun.com/maven/repository/2253054-snapshot-tANEth/'
        }
    }
